...
import com.example.administrator.servicetest.service.ILocalInterface;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.start_sub_activity).setOnClickListener(this);
    ...
    private ServiceConnection sc = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name,final IBinder service) {
            ...
            if(name.getClassName().contains(LocalService.TAG)){
                Log.e("ServiceConnection", "LocalBinder adress: " + service.hashCode() +
